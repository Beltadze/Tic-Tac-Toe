...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun init() {
        ...
        resetButton = findViewById(R.id.PlayAgainZazusha)
    ...
    private fun playGame(buttonNumber: Int, clickedView: Button) {
        if (activePlayer == 1) {
            clickedView.text = "X"
            clickedView.setBackgroundColor(Color.parseColor("#196F3D"))
            clickedView.setTextColor(Color.WHITE)
            firstPlayer.add(buttonNumber)
            activePlayer = 2
        } else {
            clickedView.text = "O"
            clickedView.setBackgroundColor(Color.parseColor("#231709"))
            clickedView.setTextColor(Color.WHITE)
    ...
    private fun PlayAgain() {
        PlayAgainZazusha.setOnClickListener{
            button1.text = ""
            button2.text = ""
            button3.text = ""
            button4.text = ""
